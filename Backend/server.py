...
app.config['SQLALCHEMY_ENGINE_OPTIONS'] = {"pool_size": SQL_POOL_SIZE, "max_overflow": SQL_MAX_OVERFLOW, 'pool_reset_on_return': None, 'pool_use_lifo'=True, 'pool_pre_ping'=True}
