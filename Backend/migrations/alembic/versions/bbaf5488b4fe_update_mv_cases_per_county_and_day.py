"""update mv cases_per_county_and_day

Revision ID: bbaf5488b4fe
Revises: 59ad7ea918b6
Create Date: 2021-03-17 19:33:32.197080
...
revision = 'bbaf5488b4fe'
down_revision = '59ad7ea918b6'
branch_labels = None
depends_on = None
    ...
    FROM cases_current t
     ...
     combined_stats AS (
         ...
         FROM new_data_per_day n
                  ...
                  LEFT JOIN population_rki_agegroup2 pa ON n.idlandkreis::text = pa.ags::text
...
FROM cc a
         ...
         LEFT JOIN survstat_cases_agegroup_berlin_hack surv ON surv.ags::text = a.ids::text AND
                                                               date_part('isoyear'::text, a."timestamp") =
                                                               surv.year::double precision AND
                                                               date_part('week'::text, a."timestamp") =
                                                               surv.week::double precision
         LEFT JOIN population_survstat_agegroup2 pop_surv ON a.ids::text = pop_surv.ags::text
